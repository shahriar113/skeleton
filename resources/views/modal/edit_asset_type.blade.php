<div id="edit_asset_type_modal" class="modal fade" style="">
...
<form class="form-horizontal" action="{{ URL::to('setup/asset_type') }}" id="" role="form" method="post" data-parsley-validate>
    ...
    <div class="modal-body pd-25">
        <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10"> Edit Asset Type </h6>
        <input type="hidden" value="" class="asset_type_id"  name="asset_type_id">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input class="form-control asset_type" type="text" name="asset_type" placeholder="Add Asset Type Name">
                    </div>
                </div><!-- col-4 -->
            </div><!-- row -->
